            ...
            <div class="card">
                <div class="row row-bordered g-0">
                    <div class="col-md-12">
                        ...
                        <x-splade-form :default="$submission" class="mb-3" action="{{ route('submission.update', $submission->hash) }}" method="PUT">
                            @csrf
                            @method('PUT')
                            <div class="row ps-4 pe-4 pt-2">
                                ...
                                <div class="col-md-6 mt-3">
                                    <x-splade-textarea type="text" name="description" :label="__('Keperluan')" autosize required />
                                </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <x-splade-file name="attachments" :show-filename="false" label="Ubah Dokumen Pendukung" />
                                </div>
                                <div class="col-md-6 mt-3">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <Link class="btn btn-danger w-30 float-end mr-2"  href="{{ route('submission.index') }}">Batal</Link>
                                </div>
                            </div>
                        </x-splade-form>
                    </div>
                ...
                <div class="card-body">
                    @foreach($verification as $note)
                        <div class="list-group mb-2 mt-2">
                            <Link as="button" class="list-group-item list-group-item-action flex-column align-items-start">
